---
layout: post
title: Daily Paper (2023.1.23 - 2023.2.17)
...
- This paper propose **two novel attention mechanisms** as modulized hierarchical designs for transformer-based 3D detectors. One is called **Simple Multi-Scale Attention** to enable feature learning at different scales. The other one is called **Size-Adaptive Local Attention** to localize feature aggregation.
