...
![Inception Module that Reduces the Grid-size](/images/DailyPaper/02/29.png "Inception Module that Reduces the Grid-size")

- Therefore, Inception V3 is presented as below. There is one thing that needed to be attentioned, the input has changed from 224 to 299.
![Inception V3](/images/DailyPaper/02/31.png "Inception V3")  
...
Inception V4
inception
v4 实际上是把原来的 inception 加上了 resnet 的方法，从一个节点能够跳过一些节点直接连入之后的一些节点，并且残差也跟着过去一个。
另外就是 V4 把一个先 11 再 33 那步换成了先 33 再 11.
论文说引入 resnet 不是用来提高深度，进而提高准确度的，只是用来提高速度的。
