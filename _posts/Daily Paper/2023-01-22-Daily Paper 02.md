...
![Spatial Pyramid Pooling in Object Detection](/images/DailyPaper/02/103.png "Spatial Pyramid Pooling in Object Detection")
...
R-CNN + SPP Net(RoI Pooling layer)
Loss function: Multi-task loss
Proposal CNN_Feature_Extractor Softmax+BBox_Regression
...
Fast R-CNN + Region Proposal Network (Replace Selective Search)
