...
- This paper proposes **U-Net** to solve the problem of medical image segmantation. The architecture of U-Net is shown below.

![U-Net](/images/DailyPaper/02/87.jpeg "U-Net")

U-Net
Less data samples + Simple semantic information
Good data argumentation
Contracting path Expanding Path
Encoder-Decoder

U-Net has a jump-connected codec structure and is able to fuse features from different layers. The fixation structure and small sample size of medical images themselves together make U-Net the best model in the field of medical image segmentation.

Why medical? Simple, few data, multimodal
