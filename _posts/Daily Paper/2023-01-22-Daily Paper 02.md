...
- This paper proposes **OverFeat**, a CNN network that simultaneously handles classification, localization, and detection. Also, the OverFeat integrates Multi-scale, Sliding windows, and Offset pooling to improve the network. 
...
- This paper proposes **You Only Look Once(YOLO)**, a one-stage object detection method rather than the two-stage method. YOLO frames object detection as a regression problem to spatially separated bounding boxes and associated class probabilities. Since YOLO is speedy, it enables assistive devices to convey real-time scene information to human users. The detection process of YOLO is shown below.
...
The class_token is added in the first position of the encoder, and use this feature as the classifier.  
