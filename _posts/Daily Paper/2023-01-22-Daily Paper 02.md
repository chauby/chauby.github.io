...
FCN
Patchwize recognition 
Replace the fully connection layer to fully convolution layer
Use up-sampling to retain the original image to do the segmentation
The details of 8x 16x 32x skip layer
