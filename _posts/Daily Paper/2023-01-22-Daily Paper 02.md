...
- This paper proposes **ShuffleNet V2** which solve some problems in ShuffleNet V1.



Use channel spit to improve the v1 version
Experiment the elements which could affect the MAC
