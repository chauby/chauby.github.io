...
Therefore, ShuffleNet v2 bases on these conclusions to improve the architecture. For example, Channel Spit is used to improve the v1 version. The building block of ShuffleNet v2 is shown below. And the ShuffleNet v2 with SE/residual block is shown in the follow.
