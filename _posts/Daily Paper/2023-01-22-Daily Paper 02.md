...
- This paper proposes a new vision Transformer **Swin Transformer** which utilizes the idea of divide-and-conquer. In this Transformer, the hierarchical structure is used to obtain the global information and the shifted window method is applied to solve the information interaction. The hierarchical feature map is shown below.
...
res-post-norm: Postpone the LN layer to the Attention behind

scaled cosine similarity
log-spaced continuous relative(Log spaced CPB): Limit the similarity to (0, 1)

position bias approach
