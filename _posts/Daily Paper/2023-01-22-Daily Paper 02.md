...
- **AlexNet** is the classical network. In this paper, **Dropout** is proposed to reduce overfutting in the fully-connected layers. The traning and testing dataset is *ImageNet LSVRC-2010*. Also, **Rectified Linear Units (ReLUs)** are applied to improve the speed of network. The overall architecture of AlexNet is shown below.
