...
- The SSD framework is shown below. Firtly, use multi-scale feature maps for detection. Secondly, use convolution to detect the result. Thirdly, use prior boxes to set the anchors which contains c + 1 confidence.
