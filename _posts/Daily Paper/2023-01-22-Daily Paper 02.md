...
- Deformable Convolution adds 2D offsets to the rgular sampling locations in the standard convolution. The details of deformable convolution are shown below.

![Deformable Convolution](/images/DailyPaper/02/6.jpeg "Deformable Convolution")

![3x3 Deformable Convolution](/images/DailyPaper/02/7.jpeg "3x3 Deformable Convolution")

- Deformable RoI Pooling adds an offset to each bin position in the regular bin partition of the previous RoI pooling. The details of deformable RoI Pooling are shown below.

![3x3 Deformable RoI Pooling](/images/DailyPaper/02/8.jpeg "3x3 Deformable RoI Pooling")

![3x3 Deformable Position-Sensitive RoI Pooling](/images/DailyPaper/02/9.jpeg "x3 Deformable Position-Sensitive RoI Pooling")

## Classical Models

### [15_LeNet_Gradient-Based Learning Applied to Document Recognition](https://ieeexplore.ieee.org/document/726791)
