...
- To increase the depth and keep the same receptive field, **three 3 x 3 convolutional kernels replace the 7 x 7 convolution kernel and two 3 x 3 convolutional kernels replace the 5 x 5 convolution kernel**. The convoluton diagram is shown below. After replacing, the number of parameters are 
