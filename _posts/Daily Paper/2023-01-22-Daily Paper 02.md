...
YOLO9000 = YOLOv2 + joint train algorithm
YOLOv2

Batch Normalization
High Resolution Classifier 224->224
Convolutional With Anchor Boxes (Remove full connected layer and use PRN anchor strategy： Odd and center)
Dimension Clusters
