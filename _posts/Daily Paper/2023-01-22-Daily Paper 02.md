...
The high resolution of low-level features and the high semantic information of high-level features can be used simultaneously to achieve good prediction effect by fusing these different layers of features.
