...
- The SSD framework is shown below. Firtly, use multi-scale feature maps for detection.
Use convolution to detect the result Prior boxes to set the anchors (c + 1 Confidence)
