...
Multiscale: Different test image input
Sliding Window method
Offset Pooling: Increase the detection grid

Regression->Merge the bounding box
OverFeat(Feature Extractor): We call these five layers, layer 1~5, the feature extraction layers and layer 6~output, the classification layers.
