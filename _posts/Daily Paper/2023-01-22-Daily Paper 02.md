...
- This paper proposes **R-FCN** which merges RPN and R-FCN. R-FCN is faster than Faster R-CNN and inprove the position-sensitivity based on Faster R-CNN, it also solves the 

![Structure of R-FCN](/images/DailyPaper/02/88.jpeg "Structure of R-FCN")

![Pooling](/images/DailyPaper/02/89.jpeg "Pooling")
...
RoI-wise subnetwork (Position-sensitive score map + Position-sensitive RoI pooling+Position-sensitive regression)
