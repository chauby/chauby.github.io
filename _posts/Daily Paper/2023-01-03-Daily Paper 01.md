...
![CDD Net](/images/DailyPaper/01/6.png "The CDD Network Structure")

![Visualization of Signal](/images/DailyPaper/01/7.png "(a) Original ECG signal (b)ECG signal after artifact removal (c)ECG signal of heartbeat (d)Image signal encoded by Hilbert curve")
